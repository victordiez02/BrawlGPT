...
const Footer = () => {
  ...
  return (
    <footer className="relative mx-auto mt-16 w-full max-w-6xl px-4 pb-10">
        ...
        <div className="relative space-y-3 text-sm">
          <div className="flex items-center justify-center gap-3">
            <img
              ...
              alt=""
              aria-hidden
              className="drop-bs size-8"
            />
            <p className="font-brawl text-lg uppercase tracking-wide text-primary">
              {t("footer_copyright")}
            </p>
          </div>
          <p className="text-foreground/80">
            <Trans
              i18nKey="footer_developer"
              components={{ strong: <strong className="text-primary" /> }}
            />
          </p>
          <div className="flex flex-wrap items-center justify-center gap-3 pt-1">
            <a
              href="mailto:victordiezporras@gmail.com"
